                ...
                @else
                    @foreach ($tipos as $tipo)
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                            ...
                            @foreach ($tipo->bibliografias as $bibliografia)
                                <!-- component -->
                                <div
                                    ...
                                    <div
                                        ...
                                        <img src="{{ $bibliografia->portada_path }}" alt="ui/ux review check"
                                    ...
                                    <div class="p-3">
                                        <div class="flex items-center justify-center">
                                            {{-- <h5 class="block font-sans text-sm font-medium italic leading-snug tracking-normal text-blue-gray-900 antialiased">
                        {{ \Illuminate\Support\Str::limit($bibliografia->descripcion, 150, '...') }}
                    </h5> --}}
                                            <h5 class="block font-sans text-sm font-medium italic leading-snug tracking-normal text-blue-gray-900 antialiased cursor-pointer"
                                                wire:click="toggleDescription({{ $bibliografia->id }})">
                                                @if (isset($expandedBibliografias[$bibliografia->id]))
